...
fn macos_036() {
    assert_eq!(
        ...
        "orn.sprig.up.lu=0+1262|\
         orn.fern.3=1+1383|\
         space=2+569|\
         orn.sprig.up.lu=3+1262|\
         orn.fern.3=4+1383|\
         space=5+569|\
         orn.zigzagline.initial=6+781|\
         orn.zigzagline.initial=7+781|\
         space=8+569|\
         orn.sprig.up.lu=9+1262|\
         orn.fern.1=10+1383|\
         space=11+569|\
         orn.sprig.up.lu=12+1262|\
         orn.egg=13+950|\
         space=14+569|\
         orn.sprig.up.lu=15+1262|\
         orn.sprig.down.rr=16+1262|\
         space=17+569|\
         orn.fern.2=18+1383|\
         orn.sprig.down.rr=19+1262|\
         space=20+569|\
         orn.fern.2=21+1383|\
         orn.sprig.down.rd=22+1262|\
         space=23+569|\
         orn.fern.2=24+1383|\
         orn.blip.down=25+853"
    );
}
...
fn macos_037() {
    assert_eq!(
        ...
        "orn.sprig.up.lu=0+1262|\
         ...
         space=2+569|\
         orn.leaf.1=3+1526|\
         orn.sprig.down.ll=4+1262|\
         space=5+569|\
         orn.sprig.up.lu=6+1262|\
         orn.sprig.down.rr=7+1262|\
         space=8+569|\
         orn.sprig.down.ll=9+1262|\
         orn.leaf.1=10+1526|\
         space=11+569|\
         orn.sprig.down.rr=12+1262|\
         orn.sprig.up.lu=13+1262|\
         space=14+569|\
         orn.fern.1=15+1383|\
         orn.sprig.up.lu=16+1262|\
         space=17+569|\
         orn.sprig.up.lu=18+1262|\
         orn.leaf.4=19+1526"
    );
}
...
fn macos_048() {
    assert_eq!(
        ...
        "orn.fern.2=0+1383|\
         orn.fleurlyse=1+1098|\
         orn.sprig.down.rr=2+1262|\
         orn.sprig.up.ll=3+1262|\
         orn.sprig.up.lu=4+1262"
    );
}
...
fn macos_154() {
    assert_eq!(
        ...
        "outline.womanHoldingHandsLeft=0+0|\
         outline.manHoldingHandsRight=0+0|\
         silhouette.WL=0+800|\
         silhouette.MR=0@-800,0+0"
    );
}
...
fn macos_157() {
    assert_eq!(
        ...
        "outline.handshakeLeft=0+0|\
         outline.handshakeRight=0+0|\
         silhouette.u1FAF1.L=0+800|\
         silhouette.u1FAF2.R=0@-800,0+0"
    );
}
