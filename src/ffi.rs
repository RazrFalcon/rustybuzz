...
extern "C" {
    ...
    pub fn hb_variation_from_string(str: *const c_char, len: i32, variation: *mut hb_variation_t) -> hb_bool_t;
    ...
    pub fn hb_buffer_pre_allocate(buffer: *mut hb_buffer_t, size: u32) -> hb_bool_t;
    pub fn hb_buffer_add_utf8(buffer: *mut hb_buffer_t, text: *const c_char, text_length: i32, item_offset: u32, item_length: i32);
    pub fn hb_buffer_get_length(buffer: *mut hb_buffer_t) -> u32;
    pub fn hb_buffer_get_glyph_infos(buffer: *mut hb_buffer_t, length: *mut u32) -> *mut hb_glyph_info_t;
    pub fn hb_buffer_get_glyph_positions(buffer: *mut hb_buffer_t, length: *mut u32) -> *mut hb_glyph_position_t;
    ...
    pub fn hb_buffer_serialize_glyphs(buffer: *mut hb_buffer_t, start: u32, end: u32, buf: *mut c_char, buf_size: u32, buf_consumed: *mut u32,
                                      font: *mut hb_font_t, format: hb_buffer_serialize_format_t, flags: hb_buffer_serialize_flags_t) -> u32;
